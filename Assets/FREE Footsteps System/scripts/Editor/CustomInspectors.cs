...
namespace Footsteps {
	...
	public class FootstepsInspector : Editor {
		...
		public override void OnInspectorGUI () {
            ...
            SerializedProperty oneAudioSource = serializedObject.FindProperty("oneAudioSource");
            SerializedProperty audioSource = serializedObject.FindProperty("audioSource");
            SerializedProperty audioSourceLeft = serializedObject.FindProperty("audioSourceLeft");
            SerializedProperty audioSourceRight = serializedObject.FindProperty("audioSourceRight");
            ...
            // Audio Sources
            EditorGUI.PropertyField(rect, oneAudioSource);
            rect.y = rect.yMax + 2;
            EditorGUI.PropertyField(rect, audioSource);
            rect.y = rect.yMax + 2;
            EditorGUI.PropertyField(rect, audioSourceLeft);
            rect.y = rect.yMax + 2;
            EditorGUI.PropertyField(rect, audioSourceRight);
            ...
            for (int i = 0;i < 16;i ++) EditorGUILayout.Space();
